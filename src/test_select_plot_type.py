...
@app.callback(
    ...
    Input(component_id = 'bollinger-nbands-dropdown', component_property = 'value'),
...
#         fig['layout']['yaxis']['dtick'] = y_delta
    ...
    return fig_div, drawdown_div_style, bollinger_div_style
